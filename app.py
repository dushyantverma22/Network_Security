...
import os
"""
This setup ensures that the Python program uses a secure, up-to-date certificate store, 
which is important for verifying SSL certificates, 
especially in applications that handle secure web requests.
"""
import certifi
ca = certifi.where()
