...
from network_security.entity.artifact import DataTransformationArtifact,ModelTrainerArtifact
from network_security.entity.config import ModelTrainerConfig, DataTransformationConfig
...
import dagshub
dagshub.init(repo_owner='dushyantverma414', repo_name='Network_Security', mlflow=True)

os.environ["MLFLOW_TRACKING_URI"]="https://dagshub.com/dushyantverma414/Network_Security.mlflow"
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric):
        mlflow.set_registry_uri("https://dagshub.com/dushyantverma414/Network_Security.mlflow")
        ...
        with mlflow.start_run():
            ...
            # Register the model if not using a file-based store
